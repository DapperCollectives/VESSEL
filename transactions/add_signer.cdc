...
transaction(treasuryAddr: Address, additionalSigner: Address, message: String, messageHex: String, keyIds: [UInt64], signatures: [String], signatureBlock: UInt64) {
  ...
  prepare(signer: AuthAccount) {
    ...
    self.action = TreasuryActionsV2.AddSigner(signer: additionalSigner, proposer: signer.address)
