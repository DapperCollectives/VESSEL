...
pub contract DAOTreasuryV5 {
  ...
  pub resource interface TreasuryPublic {
    pub fun signerApproveAction(actionUUID: UInt64, messageSignaturePayload: MyMultiSigV5.MessageSignaturePayload)
    pub fun signerRejectAction(actionUUID: UInt64, messageSignaturePayload: MyMultiSigV5.MessageSignaturePayload)
    pub fun proposeAction(action: {MyMultiSigV5.Action}, signaturePayload: MyMultiSigV5.MessageSignaturePayload): UInt64
    pub fun executeAction(actionUUID: UInt64, signaturePayload: MyMultiSigV5.MessageSignaturePayload)
    pub fun signerDepositCollection(collection: @NonFungibleToken.Collection, signaturePayload: MyMultiSigV5.MessageSignaturePayload)
    pub fun signerRemoveCollection(identifier: String, signaturePayload: MyMultiSigV5.MessageSignaturePayload)
    pub fun signerDepositVault(vault: @FungibleToken.Vault, signaturePayload: MyMultiSigV5.MessageSignaturePayload)
    pub fun signerRemoveVault(identifier: String, signaturePayload: MyMultiSigV5.MessageSignaturePayload)
    ...
    pub fun borrowManagerPublic(): &MyMultiSigV5.Manager{MyMultiSigV5.ManagerPublic}
  ...
  pub resource Treasury: MyMultiSigV5.MultiSign, TreasuryPublic {
    access(contract) let multiSignManager: @MyMultiSigV5.Manager
    ...
    */
    ...
    access(self) fun validateTreasurySigner(identifier: String, signaturePayload: MyMultiSigV5.MessageSignaturePayload) {
      ...
      // ------ Validate Block ID --------
      MyMultiSigV5.validateMessageBlockId(blockHeight: signaturePayload.signatureBlock, messageBlockId: message.slice(from: identifierHex.length, upTo: message.length))
    ...
    access(account) fun borrowManager(): &MyMultiSigV5.Manager {
      return &self.multiSignManager as &MyMultiSigV5.Manager
    }

    pub fun borrowManagerPublic(): &MyMultiSigV5.Manager{MyMultiSigV5.ManagerPublic} {
      return &self.multiSignManager as &MyMultiSigV5.Manager{MyMultiSigV5.ManagerPublic}
    }
    ...
    pub fun signerRemoveVault(identifier: String, signaturePayload: MyMultiSigV5.MessageSignaturePayload) {
      ...
      // ------ Validate Block ID --------
      MyMultiSigV5.validateMessageBlockId(blockHeight: signaturePayload.signatureBlock, messageBlockId: message.slice(from: vaultIdHex.length, upTo: message.length))
    ...
    pub fun signerDepositCollection(collection: @NonFungibleToken.Collection, signaturePayload: MyMultiSigV5.MessageSignaturePayload) {
      ...
      // ------ Validate Block ID --------
      MyMultiSigV5.validateMessageBlockId(blockHeight: signaturePayload.signatureBlock, messageBlockId: message.slice(from: collectionIdHex.length, upTo: message.length))
    ...
    init(initialSigners: [Address], initialThreshold: UInt) {
      self.multiSignManager <- MyMultiSigV5.createMultiSigManager(signers: initialSigners, threshold: initialThreshold)
      self.vaults <- {}
      self.collections <- {}
    }
  ...
  init() {
    self.TreasuryStoragePath = /storage/DAOTreasuryV5
    self.TreasuryPublicPath = /public/DAOTreasuryV5
  }
